...
//rumus menghitung hasil akhir
hasil := nil1*b1 + nil2*b2 + nil3*b3 + nil4*b4 + nil5*b5;

//if digunakan untuk mencari grade
if(hasil >= 80) then
grade := 'A'
else
if(hasil >= 70) then
...
//if digunakan untuk mencari keterangan lulus atau tidak
